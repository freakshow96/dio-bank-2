...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        print("\n@@@ Operação falhou! O saldo não é suficiente. @@@")
...
def criar_usuario(usuarios):
    ...
    data_nascimento = input("Informa oa data de nascimento (dd-mm-aa): ")
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            valor = float(input("Informa o valor que deseja sacar: "))
